...
namespace MotionViewer
{


public interface IFileDecodedNames
{
void Add(string fileName, string decodedFileName);
...
public class FileDecodedNames:IFileDecodedNames
{
    ...
    public void Add(string fileName, string decodedFileName)
    {
        lock(bl)
        {
            names.TryAdd(fileName,decodedFileName);
        }
    }
    ...
    public string Get(string fileName)
    {
        ...
        lock(bl)
        {
            names.TryGetValue(fileName,out s);
        }
